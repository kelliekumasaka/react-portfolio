...
export default function Card(props){
    return(
        <div key={props.name} className="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s">
            <div className="uk-card uk-card-body my-card  uk-visible-toggle " tabIndex={-1} uk-toggle={`target: #${props.name}-title; mode: hover`} style={{backgroundImage: `url(${props.background})`}}>
                <div className="uk-position-bottom-left my-small-overlay" id={`${props.name}-title`}>
